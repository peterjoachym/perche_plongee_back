...
class User {
  ...
  static findMany() {
    const sql = "SELECT * FROM user ORDER by lastname, firstname";
    return connection.promise().query(sql);
  }

  static findManyTrainers() {
    const sql = "SELECT * FROM user ORDER by lastname, firstname WHERE club_role=Formateur";
    return connection.promise().query(sql);
  }
